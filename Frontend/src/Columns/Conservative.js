...
import background from "../Images/Backgrounds/conservativeCorner.png";
import headshot from "../Images/HeadShots/Paul1nb.png";
import title from "../Images/Titles/conservativeCorner.png"

const Conservative = () => {
    // const [content, setContent] = useState('');
    const column = ColumnData("Conservative", "Paul Swanson");
